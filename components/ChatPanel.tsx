...
interface QuoteData { type: "quote"; quote: SimulationResult; fromSymbol: string; toSymbol: string; amount: number; scanDecision: string; source: string; approvalId?: string; }
