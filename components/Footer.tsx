...
export function Footer() {
  return (
    ...
    >
      {/* overflow-hidden on footer ensures the -bottom-[10%] AEGISX backdrop
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-5 gap-12 relative z-10">
        <div className="lg:col-span-2">
          ...
          <p className="mt-4 max-w-sm text-white/60 leading-relaxed">
            The intelligence and protection layer for on-chain traders. Curate. Detect. Protect.
          </p>
        </div>
        {cols.map((c) => (
          <div key={c.title}>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 mt-16 pb-8 flex flex-wrap justify-between items-center gap-4 relative z-10 border-t border-white/10 pt-8">
        <p className="text-sm text-white/60">© {new Date().getFullYear()} AegisX. All rights reserved.</p>
        <p className="text-sm text-white/80 tracking-[0.25em] uppercase">Curate · Detect · Protect</p>
      </div>
