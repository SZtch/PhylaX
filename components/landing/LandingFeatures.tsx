...
const features: Feature[] = [
  ...
  { title: "AI Copilot Intelligence", desc: "Chat-based DeFi guidance powered by AI. Ask anything about a token, market, or trade — and get clear, actionable analysis instantly.", icon: BrainCircuit, accent: "oklch(0.78 0.12 220)" },
  { title: "Wallet-Gated Execution", desc: "PhylaX prepares your swap via X-Agent skills and OKX DEX. You review everything and sign the final transaction from your own wallet. Always.", icon: Lock, accent: "oklch(0.45 0.13 270)", span: "md:col-span-2" },
];
